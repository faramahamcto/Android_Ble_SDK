...
class _HomePageState extends State<HomePage> {
  ...
  Future<void> _connectToDevice(VeepooDevice device) async {
    try {
      ...
      if (connected) {
        // Sync personal info
        await _sdk.syncPersonInfo(PersonInfo(
          height: 170,
          weight: 70.0,
          age: 25,
          sex: 1,
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          Expanded(
            child: _isConnected ? _buildHealthDataView() : _buildDeviceList(),
          ),
        ],
      ),
  ...
  Widget _buildDeviceList() {
    if (_devices.isEmpty && !_isScanning) {
      return const Center(
        child: Text('Tap the search button to scan for devices'),
      );
    }
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ElevatedButton(
                        onPressed: _startHeartRateMonitoring,
                        child: const Text('Start'),
                      ),
                      const SizedBox(width: 8),
                      ElevatedButton(
                        onPressed: _stopHeartRateMonitoring,
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 8),
                  ElevatedButton(
                    onPressed: _measureBloodPressure,
